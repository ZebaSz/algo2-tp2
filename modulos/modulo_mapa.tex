...
\begin{Interfaz}
	...
	\tadOperacion{alto}{mapa/m}{nat}{}
	\tadOperacion{ancho}{mapa/m}{nat}{}

	\tadAxiomas
	% TODO completar axiomas
	\tadAxioma{alto(m)}{}
...
\begin{Representacion}
	...
	\begin{enumerate}
		...
		\item Si dos posiciones no tienen un camino de posiciones adyacentes de mismo grupo que las una, deben tener grupos distintos.\footnote{No pudimos expresar esto en rep, lo dejamos en castellano} % TODO esto es medio fruta
...
\begin{Algoritmos}
	...
	\begin{algorithm}[H]
		...
		% TODO
		\Pre{\texttt{true}} 
		\Post{TODO} % se podrá poner true y ya?
		\BlankLine

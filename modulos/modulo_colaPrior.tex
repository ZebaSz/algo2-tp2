...
\begin{Representacion}
	...
	\begin{enumerate}
		...
		\item El menor es efectivamente el menor de conjElem %TODO no estamos chequeando que efectivamente exista ese menor (podrían ser todos mayores y ya)
	...
	%%TODO (naxio dejo este todo, nideawachem)


	\TituloDis{Representación del iterador}

	\begin{Estructura}{itColaPrior}[eItCola]
		\begin{Tupla}[eItCola]
			\tupItem{itConjElem}{itConjOrd($\alpha$)}
		\end{Tupla}
	\end{Estructura}
...
\begin{Algoritmos}
	...
	\begin{algorithm}[H]
		...
		res $\leftarrow$ Actual(c.menor)\OdeLinea{1}
	\end{algorithm}

...
\begin{Algoritmos}
	\TituloDis{Algorítmos de DiccionarioPrioridad}
	...
	\begin{algorithm}[H]
		...
		\uElseIf{j $<$ (*nodo).id}{
			res $\leftarrow$ BuscarJ(j, (*nodo).hijoIzq)\OdeLinea{h - 1}
		}
		\Else{
			res $\leftarrow$ BuscarJ(j, (*nodo).hijoDer)\OdeLinea{h - 1}
		}
	\end{algorithm}
	...
	\begin{algorithm}[H]
		...
		\eIf{nodo = NULL}{
			...
			\eIf{j $<$ n.id}{
				(*nodo).hijoIzq $\leftarrow$ InsertarJ(j, n, (*nodo).hijoIzq)\OdeLinea{h - 1}
			}{
				(*nodo).hijoDer $\leftarrow$ InsertarJ(j, n, (*nodo).hijoDer)\OdeLinea{h - 1}
			}
	...
	\pre: entre los nodo que desprenden del nodo del parametro no se encuentra el id j.

	\post: res es el mismo nodo pero ahora con el hijo insertado en esa rama y balanceado
	...
	\begin{algorithm}[H]
		...
		\uElseIf{j $<$ (*nodo).id}{
			(*nodo).hijoIzq $\leftarrow$ RemoverJ(j, (*nodo).hijoIzq)\OdeLinea{h - 1}
			res $\leftarrow$ Balancear(nodo)\OdeLinea{1}
		}
		\uElseIf{j $>$ (*nodo).id}{
			(*nodo).hijoDer $\leftarrow$ RemoverJ(j, (*nodo).hijoDer)\OdeLinea{h - 1}
			res $\leftarrow$ Balancear(nodo)\OdeLinea{1}
		}
		\Else{
			...
			\eIf{d = NULL}{
				...
				puntero(Nodo): minimo $\leftarrow$ BuscarMinimo(d)\OdeLinea{h - 1}
				minimo.hijoDer $\leftarrow$ RemoverMinimo(d)\OdeLinea{log(\#j)}
	...
	\begin{algorithm}[H]
		...
		\eIf{(*nodo).hijoIzq = NULL}{
			...
			res $\leftarrow$ BuscarMinimo((*nodo).hijoIzq)\OdeLinea{log(\#j)}
		}
	\end{algorithm}
	...
	\begin{algorithm}[H]
		...
		\eIf{(*nodo).hijoIzq = NULL}{
			...
			(*nodo).hijoIzq = RemoverMinimo((*nodo).hijoIzq)\OdeLinea{log(\#j)}
			res $\leftarrow$ Balancear(nodo)\OdeLinea{1}
		}
	\end{algorithm}
	...
	\begin{algorithm}[H]
		...
		\eIf{nodo = NULL \textbf{or} ((*nodo).id = jugador \textbf{and} (*nodo).cantPokemons = n)}{
			...
			\eIf{n $<$ (*nodo).cantPokemons \textbf{or} (n = (*nodo).cantPokemons \textbf{and} j $<$ (*nodo).id)}{
				res $\leftarrow$ BuscarN(j, n, (*nodo).hijoIzq)\OdeLinea{log(\#j)}
			}{
				res $\leftarrow$ BuscarN(j, n, (*nodo).hijoDer)\OdeLinea{log(\#j)}
			}
		}
	\end{algorithm}
	...
	\begin{algorithm}[H]
		...
		\eIf{nodo = NULL}{
			...
			\eIf{n $<$ (*nodo).cantPokemons \textbf{or} (n = (*nodo).cantPokemons \textbf{and} j $<$ (*nodo).id)}{
				(*nodo).hijoIzq $\leftarrow$ InsertarN(j, n, (*nodo).hijoIzq)\OdeLinea{log(\#j)}
			}{
				(*nodo).hijoDer $\leftarrow$ InsertarN(j, n, (*nodo).hijoDer)\OdeLinea{log(\#j)}
			}
			res $\leftarrow$ Balancear(nodo)\OdeLinea{1}
		}
	\end{algorithm}
	...
	\begin{algorithm}[H]
		...
		\uElseIf{n $<$ (*nodo).cantPokemons \textbf{or} (n = (*nodo).cantPokemons \textbf{and} j $<$ (*nodo).id)}{
			(*nodo).hijoIzq $\leftarrow$ RemoverN(j, n, (*nodo).hijoIzq)\OdeLinea{log(\#j)}
			res $\leftarrow$ Balancear(nodo)\OdeLinea{1}
		}
		\uElseIf{n $>$ (*nodo).cantPokemons \textbf{or} (n = (*nodo).cantPokemons \textbf{and} j $>$ (*nodo).id)}{
			(*nodo).hijoDer $\leftarrow$ RemoverN(j, n, (*nodo).hijoDer)\OdeLinea{log(\#j)}
			res $\leftarrow$ Balancear(nodo)\OdeLinea{1}
		}
		\Else{
			puntero(Nodo): i $\leftarrow$ (*nodo).hijoIzq\OdeLinea{1}
			...
			\eIf{d = NULL}{
				...
				puntero(Nodo): minimo $\leftarrow$ BuscarMinimo(d)\OdeLinea{log(\#j)}
				minimo.hijoDer $\leftarrow$ RemoverMinimo(d)\OdeLinea{log(\#j)}
				minimo.hijoIzq $\leftarrow$ i\OdeLinea{1}
				res $\leftarrow$ Balancear(minimo)\OdeLinea{1}
			}

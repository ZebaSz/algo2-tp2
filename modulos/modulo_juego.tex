...
\begin{Algoritmos}
	...
	\TituloDis{Algorítmos auxiliares}
	...
	\post: res es igual al conjunto de posiciones válidas cerca de $c$, con distancia euclidiana máxima de $n^2$.\footnote Se usa la definición de Coordenada de distancia euclidiana, que no implica la raíz cuadrada.

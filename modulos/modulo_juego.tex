...
\begin{Representacion}
	...
	%TODO agregar a Rep
		...
		\item En pokemons, para cada clave su significado es la suma de todos los significados de infoJugadores donde la clave existe y el jugador no fue eliminado, más la cantidad de coordenadas de posConPokemons donde el pokemon se encuentra

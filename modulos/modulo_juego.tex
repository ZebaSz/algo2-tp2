...
\begin{Algoritmos}
	...
	\begin{algorithm}[H]
		...
		\While{HayMas?(it)}{
			...
			\If{DistEuclidead(c, coorConPk) $>$ 4}{
				j.grillaPos[Latitud(coorConPk)][Longitud(coorConPk)].contadorCaptura $\leftarrow$ j.grillaPos[Latitud(coorConPk)][Longitud(coorConPk)].contadorCaptura +1 \;
				\If{j.grillaPos[Latitud(coorConPk)][Longitud(coorConPk)].contadorCaptura = 10}{
					%%TODO CAPTURA
				}
			}

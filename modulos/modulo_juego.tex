...
\begin{Representacion}
	...
	\begin{Estructura}{Juego}[pokego]
		...
		\begin{Tupla}[infoPos]
			...
			\tupItem{jugEsperandoCaptura}{colaPrior}
	...
	\tadOperacion{jugadoresEsperandoCaptura}{pokego, conj(coor)}{bool}{} %TODO despues de definir la tupla, hay que cambiar estas funciones

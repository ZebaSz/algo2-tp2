...
\begin{Representacion}
	...
	\begin{enumerate}
		...
		\item En los jugadores que se encutuentran en la grilla solo estan los que realmente se encuentran ahi %DONE

		\item Solo las posiciones con pokemon tienen pokemons en la grilla%Done

		\item CantPokemons es igual a la suma de todas los significados del diccionario %Done

		\item Los significados del diccionario de pokemons es igual a la cantidad de pokemons que hay capturados mas los salvajes %Done
	...
	\Rep[pokego][e]{
		...
		jugadoresConectadosEnPosValidas $\yluego$\\
